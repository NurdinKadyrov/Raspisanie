...
public class Main {
    public static void main(String[] args) {
        ...
        int f = rd.nextInt(1, 6);
        if (f >= 1 && f <= 2) {
            System.out.println(words[9]);
            neUdachnyi++;
            int g = rd.nextInt(1, 9);
            if (g >= 1 && g <= 2) {
                System.out.println(words[10]);
                neUdachnyi++;
                int j = rd.nextInt(1, 9);
                if (j >= 1 && j <= 2) {
